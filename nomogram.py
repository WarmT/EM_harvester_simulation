...
ax.text(11e3, 6.5e-4,  r"$10\,\mathrm{nm}$", rotation=45, ha='left', va='bottom', fontsize=f_size)
ax.text(11e3, 6.5e-3, r"$100\,\mathrm{nm}$", rotation=45, ha='left', va='bottom', fontsize=f_size)
ax.text(11e3, 6.5e-2,   r"$1\,\mathrm{um}$", rotation=45, ha='left', va='bottom', fontsize=f_size)
ax.text(11e3, 6.5e-1,  r"$10\,\mathrm{um}$", rotation=45, ha='left', va='bottom', fontsize=f_size)
ax.text(11e3, 6.5e-0, r"$100\,\mathrm{um}$", rotation=45, ha='left', va='bottom', fontsize=f_size)
#ax.text(11e3, 6.5e1,  r"$100\,\mathrm{mm}$", rotation=45, ha='left', va='bottom', fontsize=f_size)
ax.text(1.7e3, 10,      r"$1\,\mathrm{mm}$", rotation=45, ha='left', va='bottom', fontsize=f_size)
ax.text(1.7e2, 10,     r"$10\,\mathrm{mm}$", rotation=45, ha='left', va='bottom', fontsize=f_size)
...
plt.savefig("pics/vibration_nomogram.pdf")
raw_input("haa")
plt.close()
